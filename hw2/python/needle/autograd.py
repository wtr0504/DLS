...
# 调用流程 “+“ -> Tensor.__add__ -> EWiseAdd -> TensorOp.__call__ -> Tensor.make_from_op -> EWiseAdd.compute
...
def compute_gradient_of_variables(output_tensor:Tensor, out_grad):
    ...
    for node in reverse_topo_order:
      node_grad = node_to_output_grads_list[node]
      grad_sum = sum_node_list(node_grad)
      node.grad = grad_sum
